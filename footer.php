					...
					<div class="row">
						<div class="col-md-3 col-xs-6">
							<div class="footer">
								...
								<p>Đây là một đồ án nhỏ môn đồ án tổng hợp</p>
								<ul class="footer-links">
									<li><a href="#"><i class="fa fa-map-marker"></i>Hà Nội ,Việt Nam</a></li>
									<li><a href="#"><i class="fa fa-phone"></i>+84-686868686</a></li>
									<li><a href="#"><i class="fa fa-envelope-o"></i>hhtcompany@gmail.com</a></li>
								</ul>
							</div>
						</div>
						<div class="col-md-6 text-center" style="margin-top:80px;">
							...
							<span class="copyright">
								...
								Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="#" target="_blank">hhtComany</a>
							<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
							</span>
						</div>
	...
	<div class="section">
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-3 col-xs-6">
					<div class="footer">
						<h3 class="footer-title">Giới thiệu về HHT</h3>
						<p>Đây là một đồ án nhỏ môn đồ án tổng hợp</p>
						<ul class="footer-links">
							<li><a href="#"><i class="fa fa-map-marker"></i>Hà Nội ,Việt Nam</a></li>
							<li><a href="#"><i class="fa fa-phone"></i>+84-686868686</a></li>
