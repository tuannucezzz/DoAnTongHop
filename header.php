						...
						<div class="header-search">
							<form onsubmit="return false" style="display: flex; justify-content: center;">
								<select class="input-select" style="display: none;">
									<option value="0">Tất cả danh sách</option>
									<!-- <option value="1">Men</option>
										<option value="1">Women </option> -->
								</select>
								<input class="input" id="search" type="text" placeholder="Nhập thương hiệu cần tìm">
...
>>>>>>> Stashed changes
							...
							<div class="dropdown">
								...
								<div class="cart-dropdown">
									...
									<div class="cart-btns">
										<a href="cart.php" style="width:100%;"><i class="fa fa-edit"></i> Sửa giỏ
											hàng</a>
