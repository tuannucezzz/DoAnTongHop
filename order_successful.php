  ...
  <head>
    ...
    <body>
      ...
      <div style="border-radius:200px; height:200px; width:200px; background: #F8FAF5; margin:0 auto;">
        ...
        <p>Chúng tôi đã nhận được yêu cầu mua hàng của bạn;<br/> Chúng tôi sẽ liên lạc sớm nhất!</p>
        <div class="heading">
            <br><br><br>
                <a href="store.php" style="float:left" class="continue">Tiếp tục mua sắm</a>
                <a href="myorders.php" style="float:right" class="continue">Đơn hàng của tôi</a>
            </div>
      </div>
