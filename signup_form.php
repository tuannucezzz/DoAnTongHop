...
<link rel="stylesheet" type="text/css" href="css/utils.css">
  ...
  transform: scaleX(-1);"></div>
		...
		<input class="input100" type="text" name="f_name" id="f_name" placeholder="Họ">
		<span class="focus-input100"></span>
		</div>
		<div class="wrap-input100 validate-input" data-validate="Name is required">
		<span class="label-input100">Tên</span>
		<input class="input100" type="text" name="l_name" id="l_name" placeholder="Tên">
		<span class="focus-input100"></span>
		</div>
		...
		<input class="input100" type="text" name="mobile" id="mobile" placeholder="SĐT">
		<span class="focus-input100"></span>
		</div>
		...
		<input class="input100" type="text" name="address1" id="address1" placeholder="Địa chỉ">
		<span class="focus-input100"></span>
		</div>
		<div class="wrap-input100 validate-input" data-validate="City is required">
		<span class="label-input100">Thành Phố</span>
		<input class="input100" type="text" name="address2" id="address2" placeholder="Thành Phố">
		<span class="focus-input100"></span>
		</div>
