<div class="main main-raised">
    <div class="container mainn-raised" style="width:100%;">
        ...
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <<<<<<< Updated upstream <div class="item active">
    ...
    <div class="section mainn mainn-raised">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <<<<<<< Updated upstream <!-- section title -->
                    <div class="col-md-12">
...
<<<<<<< Updated upstream
			...
			";
                                    ...
                                    ?>
                                                    ...
                                                    <<<<<<< Updated upstream <!-- HOT DEAL SECTION -->
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="hot-deal">
                                                                            ...
                                                                            <h2 class="text-uppercase">hot deal this
                                                                                week</h2>
                                                                            <p>New Collection Up to 50% OFF</p>
                                                                            <a class="primary-btn cta-btn"
                                                                                href="store.php">Shop now</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <!-- /row -->
                                                            ...
                                                            <div id="get_product_home2">
                                                                ...
                                                                <div class="product-widget">
                                                                    ...
                                                                    <div class="product-body">
                                                                        ...
                                                                        <h3 class="product-name"><a href="#">Tên sản
                                                                                phẩm ở đây</a></h3>
                                                                        <h4 class="product-price">62,849,000Đ <del
                                                                                class="product-old-price">92,849,000Đ</del>
                                                                        </h4>
                                                                    </div>
                                                                </div>
                                                                <!-- /product widget -->
                                                                ...
                                                                <div class="product-widget">
                                                                    ...
                                                                    <div class="product-body">
                                                                        ...
                                                                        <h3 class="product-name"><a href="#">Tên sản
                                                                                phẩm ở đây</a></h3>
                                                                        <h4 class="product-price">68,849,000Đ <del
                                                                                class="product-old-price">92,849,000Đ</del>
                                                                        </h4>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="product-widget">
                                                                    ...
                                                                    <div class="product-body">
                                                                        ...
                                                                        <h3 class="product-name"><a href="#">Tên sản
                                                                                phẩm ở đây</a></h3>
                                                                        <h4 class="product-price">54,849,000Đ <del
                                                                                class="product-old-price">92,849,000Đ</del>
                                                                        </h4>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <div class="col-md-4 col-xs-6">
                                                        ...
                                                        <div class="products-widget-slick" data-nav="#slick-nav-4">
                                                            <div>
                                                                ...
                                                                <div class="product-widget">
                                                                    <div class="product-img">
                                                                        <img src="./product_images/alienware1.png"
                                                                            alt="">
                                                                    </div>
                                                                    <div class="product-body">
                                                                        <p class="product-category">Loại sản phẩm</p>
                                                                        <h3 class="product-name"><a href="#">Tên sản
                                                                                phẩm ở đây</a></h3>
                                                                        <h4 class="product-price">20,849,000Đ <del
                                                                                class="product-old-price">92,849,000Đ</del>
                                                                        </h4>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="product-widget">
                                                                    <div class="product-img">
                                                                        <img src="./product_images/alienware2.png"
                                                                            alt="">
                                                                    </div>
                                                                    <div class="product-body">
                                                                        <p class="product-category">Loại sản phẩm</p>
                                                                ...
                                                                <div class="product-widget">
                                                                    <div class="product-img">
                                                                        <img src="./product_images/alienware3.png"
                                                                            alt="">
                                                                    </div>
                                                                    <div class="product-body">
                                                                        <p class="product-category">Loại sản phẩm</p>
                                                                        <h3 class="product-name"><a href="#">Tên sản
                                                                                phẩm ở đây</a></h3>
                                                                        <h4 class="product-price">24,849,000Đ <del
                                                                                class="product-old-price">92,849,000Đ</del>
                                                                        </h4>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="product-widget">
                                                                    ...
                                                                    <div class="product-body">
                                                                        ...
                                                                        <h3 class="product-name"><a href="#">Tên sản
                                                                                phẩm ở đây</a></h3>
                                                                        <h4 class="product-price">52,849,000Đ <del
                                                                                class="product-old-price">92,849,000Đ</del>
                                                                        </h4>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="product-widget">
                                                                    ...
                                                                    <div class="product-body">
                                                                        ...
                                                                        <h3 class="product-name"><a href="#">Tên sản
                                                                                phẩm ở đây</a></h3>
                                                                        <h4 class="product-price">22,849,000Đ <del
                                                                                class="product-old-price">92,849,000Đ</del>
                                                                        </h4>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="product-widget">
                                                                    ...
                                                                    <div class="product-body">
                                                                        ...
                                                                        <h3 class="product-name"><a href="#">Tên sản
                                                                                phẩm ở đây</a></h3>
                                                                        <h4 class="product-price">12,849,000Đ <del
                                                                                class="product-old-price">92,849,000Đ</del>
                                                                        </h4>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="product-widget">
                                                                    ...
                                                                    <div class="product-body">
                                                                        ...
                                                                        <h3 class="product-name"><a href="#">Tên sản
                                                                                phẩm ở đây</a></h3>
                                                                        <h4 class="product-price">25,849,000Đ <del
                                                                                class="product-old-price">92,849,000Đ</del>
                                                                        </h4>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="product-widget">
                                                                    ...
                                                                    <div class="product-body">
                                                                        ...
                                                                        <h3 class="product-name"><a href="#">Tên sản
                                                                                phẩm ở đây</a></h3>
                                                                        <h4 class="product-price">32,849,000Đ <del
                                                                                class="product-old-price">92,849,000Đ</del>
                                                                        </h4>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="product-widget">
                                                                    ...
                                                                    <div class="product-body">
                                                                        ...
                                                                        <h3 class="product-name"><a href="#">Tên sản
                                                                                phẩm ở đây</a></h3>
                                                                        <h4 class="product-price">28,849,000Đ <del
                                                                                class="product-old-price">92,849,000Đ</del>
                                                                        </h4>
                                                                    </div>
                                                                </div>
